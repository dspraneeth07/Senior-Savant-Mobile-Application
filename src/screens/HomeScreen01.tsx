  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{marginTop: 70}}>
        ...
        <View style={{ alignItems: 'center', marginTop: 40 }}>
          <TouchableOpacity style={{backgroundColor: "#FFC107", paddingHorizontal: 32, height: 52, borderRadius: 100, alignItems: 'center', justifyContent: 'center'}} onPress={() => {navigation.navigate("NewsList")}}>
